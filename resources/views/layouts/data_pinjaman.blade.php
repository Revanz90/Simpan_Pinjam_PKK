                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center d-flex flex-column align-items-stretch" style="gap: 4px">
                            <a class="btn btn-info btn-xs" href="{{ route('detail_pinjaman') }}">
...
<!-- Modal Tambah Data Pinjaman -->
<div class="modal fade" id="modal-default">
    <div class="modal-dialog" style="max-width: 80%">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Data Pinjaman</h4>
            ...
            <div class="modal-body">
                <section class="content">
                    <div class="card">
                        <!-- Navbar Content -->
                        <div class="card-header ">
                            <h4 class="card-title font-weight-bold">TAMBAH DATA PINJAMAN</h4>
...
<!-- Modal Cetak Data Pinjaman -->
<div class="modal fade" id="modal-default1">
    <div class="modal-dialog" style="max-width: 80%">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Cetak Data Pinjaman Tahunan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <section class="content">
                    <div class="card">
                        <!-- Navbar Content -->
                        <div class="card-header ">
                            <h4 class="card-title font-weight-bold">CETAK DATA PINJAMAN TAHUNAN</h4>
                            <div class="card-tools"></div>
                        </div>
                        <!-- /Navbar Content -->
                        <!-- Page Content -->
